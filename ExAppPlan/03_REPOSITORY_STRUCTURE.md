...
- [ ] TODO — создать solution `ExApp.sln`
- [ ] TODO — создать проекты из `src/`
- [ ] TODO — добавить `Directory.Build.props`
- [ ] TODO — включить nullable
- [ ] TODO — включить analyzers
- [ ] TODO — добавить базовый CI build
- [ ] TODO — перенести docs
