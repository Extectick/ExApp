...
- [x] DONE — parse valid manifest
- [x] DONE — reject invalid manifest
- [x] DONE — reject unsupported apiVersion
- [x] DONE — reject incompatible minAppVersion
- [x] DONE — validate checksums
- [x] DONE — reject corrupted package
...
- [x] DONE — install mock service
- [x] DONE — uninstall mock service
- [x] DONE — update mock service
- [x] DONE — manual rollback after update
- [x] DONE — preserve data on uninstall
- [x] DONE — delete data when requested

### IPC

- [x] DONE — Desktop connects to Agent
- [x] DONE — command request/response works
- [x] DONE — invalid command rejected
- [x] DONE — command timeout works
- [x] DONE — logs request works
- [x] DONE — unauthorized cross-user client rejected by current-user-only pipe
